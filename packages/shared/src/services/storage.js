...
export class StorageService {
            ...
            try {
                ...
                if (!bucketExists) {
                    ...
                    const { error } = await supabase.storage.createBucket(bucketName, {
                        public: bucketName === this.BUCKETS.AVATARS ||
     ...
     */
    static async listFiles(bucket, path, limit) {
        try {
            const listOptions = {
     ...
     */
    static generateFilePath(userId, bucket, fileName) {
     ...
     */
    static getAllowedMimeTypes(bucket) {
        switch (bucket) {
     ...
     */
    static getFileSizeLimit(bucket) {
        switch (bucket) {
            case this.BUCKETS.AVATARS:
...
Object.defineProperty(StorageService, "BUCKETS", {
    enumerable: true,
    configurable: true,
    writable: true,
    value: {
