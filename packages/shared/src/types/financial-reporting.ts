...
export interface FinancialReportParams {
  ...
  startDate: Date;
  endDate: Date;
  entityId?: string; // operator ID, host ID, etc.
...
// Commission system types for hosted parking
...
export enum FinancialAuditType {
...
export enum FinancialAuditStatus {
  PLANNED = 'planned',
