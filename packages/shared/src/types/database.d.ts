...
export declare const Constants: {
    readonly public: {
        readonly Enums: {
            readonly ad_content_type: readonly ["image", "video", "text", "banner", "interstitial"];
            readonly ad_status: readonly ["pending", "approved", "active", "paused", "completed"];
            readonly ad_target_type: readonly ["section", "zone"];
            readonly booking_status: readonly ["pending", "confirmed", "active", "completed", "cancelled"];
            readonly conversation_type: readonly ["user_host", "user_operator", "user_support"];
            readonly discrepancy_type: readonly ["amount_mismatch", "missing_revenue_share", "missing_transaction", "status_mismatch", "duplicate_entry"];
            readonly financial_report_type: readonly ["operator_revenue", "host_revenue", "transaction_reconciliation", "payout_summary", "revenue_analysis"];
            readonly message_type: readonly ["text", "image", "file"];
            readonly parking_type: readonly ["hosted", "street", "facility"];
            readonly payment_intent_status: readonly ["requires_payment_method", "requires_confirmation", "requires_action", "processing", "succeeded", "cancelled"];
            readonly payment_method_type: readonly ["credit_card", "debit_card", "digital_wallet", "bank_transfer"];
            readonly payment_provider: readonly ["stripe", "paypal", "gcash", "paymaya", "park_angel"];
            readonly payment_status: readonly ["pending", "paid", "refunded"];
            readonly payment_transaction_status: readonly ["pending", "processing", "succeeded", "failed", "cancelled", "refunded", "partially_refunded"];
            readonly payout_status: readonly ["pending", "processing", "paid", "failed", "cancelled"];
            readonly rated_type: readonly ["spot", "host", "operator", "user"];
            readonly reconciliation_rule_type: readonly ["amount_validation", "status_check", "duplicate_detection", "completeness_check"];
            readonly remittance_frequency: readonly ["daily", "weekly", "biweekly", "monthly"];
            readonly remittance_status: readonly ["pending", "processing", "completed", "failed", "cancelled"];
            readonly spot_status: readonly ["available", "occupied", "reserved", "maintenance"];
            readonly target_type: readonly ["section", "zone"];
            readonly user_status: readonly ["active", "inactive", "suspended"];
            readonly user_type: readonly ["client", "host", "operator", "admin", "pos"];
            readonly vip_type: readonly ["vvip", "flex_vvip", "spot_vip", "spot_flex_vip"];
        };
    };
};
export {};
