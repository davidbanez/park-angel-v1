...
export type LayoutElementType = 'parking-spot' | 'entrance' | 'exit' | 'two-way-lane' | 'one-way-lane' | 'elevator' | 'stairs' | 'pillar' | 'wall' | 'barrier' | 'pedestrian-walkway' | 'disabled-spot' | 'electric-charging' | 'motorcycle-spot';
